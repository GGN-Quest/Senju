/* Fichier : Gougnon.CSS.framework.cssg, Nom : Gougnon CSS Framework, version 0.0.1.160119.1425, site: http://gougnon.com , Copyright 2013 GOBOU Y. Yannick */
<?php
...
$Core->selector('.text-lower-first:first-letter',['text-transform'=>'uppercase'] );
...
$Core->selector('.gui-transition,.gui-fx', ['transition'=>'all 150ms ease']);
